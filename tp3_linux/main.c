...
/****************************************************
    Menu:
     ...
     3. Alta de empleado
    de los e 4. Modificar datos de empleado
     5. Baja de empleado
     6. Listar empleados
     7. Ordenar empleados
...
int main()
{
    ...
    do{
        ...
        {
            case 1:
				idMaximo = controller_loadFromText("data.csv",listaEmpleados);
            	break;
            case 2:
               	idMaximo = controller_loadFromBinary("data.csv", listaEmpleados);
            	break;
            case 3:
